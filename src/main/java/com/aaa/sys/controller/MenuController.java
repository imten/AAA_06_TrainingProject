...
import com.aaa.sys.common.Constast;
import com.aaa.sys.common.DataGridView;
import com.aaa.sys.common.ResultObj;
import com.aaa.sys.common.TreeNode;
import com.aaa.sys.common.TreeNodeBuilder;
...
public class MenuController {
	...
	public ResultObj addMenu(PermissionVo permissionVo) {
		try {
			...
			systemLog("添加","添加菜单（"+permissionVo.getTitle()+")");
	...
	public ResultObj updateMenu(PermissionVo permissionVo) {
		try {
			...
			systemLog("修改","修改菜单（"+permissionVo.getTitle()+")");
	...
	public ResultObj deleteMenu(PermissionVo permissionVo) {
		try {
			...
			systemLog("删除","删除菜单（"+permissionVo.getTitle()+")");
